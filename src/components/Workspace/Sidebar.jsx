...
const NAV_ITEMS = [
  { label: "AI Workspace", icon: LayoutGrid, path: "/workspace" },
...
function SidebarContent() {
  ...
  return (
    <div className="flex h-full flex-col">
      <Link to="/workspace" className="flex items-center gap-2 px-2 font-display text-xl font-bold text-slate-900">
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 flex items-center justify-between border-b border-slate-100 bg-white/70 px-5 py-4 backdrop-blur-xl lg:hidden">
        <Link to="/workspace" className="flex items-center gap-2 font-display text-lg font-bold text-slate-900">
